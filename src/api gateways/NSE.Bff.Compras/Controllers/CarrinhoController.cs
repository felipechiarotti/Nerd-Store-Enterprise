...
namespace NSE.Bff.Compras.Controllers
{
    ...
    public class CarrinhoController : MainController
    {
        ...
        public async Task<IActionResult> AtualizarItemCarrinho(Guid produtoId, ItemCarrinhoDTO itemProduto)
        {
            ...
            var resposta = await _carrinhoService.AtualizarItemCarrinhho(produtoId, itemProduto);
        ...
        private async Task ValidarItemCarrinho(ItemProdutoDTO produto, int quantidade)
        {
            ...
            if (quantidade > produto.QuantidadeEstoque) AdicionarErroProcessamento($"O produto {produto.Nome} possui apenas {produto.QuantidadeEstoque} unidades");
        }
    }
}
